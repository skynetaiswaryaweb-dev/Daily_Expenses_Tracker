...
const App = () => {
  ...
  // Check login status on mount - stays logged in until logout
  useEffect(() => {
  ...
  // Save transactions for specific user
  const saveTransactions = (user, data) => {
  ...
  // Handle Logout - only way to logout
  const handleLogout = () => {
  ...
  // Delete Transaction - Now permanently deletes
